...
@EndUserText.label: 'Projection View for Taxonomy Text'
@OData.publish: true
@Search.searchable: true
@Metadata.allowExtensions: true

// Projection View Definition
define root view entity ZMDG_TAX_TEXT_PV
  as projection on ZMDG_TAX_TEXT_VW
{
